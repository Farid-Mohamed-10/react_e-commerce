...
import PlusMinusBtns from "../../../Components/Website/Btns/PlusMinusBtns";
    ...
    <Container className="my-5">
      <div className="d-flex align-items-start flex-wrap row-gap-5">
        {loading ? (
          <>
            <div className="col-lg-4 col-md-6 col-12">
              ...
              <div className="col-12 d-flex mt-1">
                <SkeletonShow height="100px" length="3" classes="col-4" />
              </div>
            </div>
            <div className="col-lg-7 col-md-6 col-12">
              <div className="ms-lg-5">
                <SkeletonShow height="20px" length="1" classes="col-lg-8 col-12" />
                <SkeletonShow height="210px" length="1" classes="col-lg-8 col-12 mt-2" />
          ...
          <>
            <div className="col-lg-4 col-md-6 col-12">
              <ImageGallery bulletClass showBullets={true} items={productImages} />
            </div>
            <div className="col-lg-7 col-md-6 col-12">
              <div className="ms-5">
                <h1>{product.title}</h1>
                ...
                <div className="d-flex align-items-center justify-content-between pt-4 border-top">
                    <div>
                      {product.stock === 1 && (
                        <p className="text-danger">Ther is only one left</p>
                      )}
                    {showGoldStars}
                    {showEmptyStars}
                  ...
                  {product.stock === 0 ? (
                    ...
                    <div className="d-flex align-items-center gap-4">
                      <PlusMinusBtns setCount={(data) => setCount(data)} />
                      <div
                        onClick={handleSave}
